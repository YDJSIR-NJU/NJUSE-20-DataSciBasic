...
def keywordsInit():
    ...
    #         fp2.write(newWords)
    #         fp2.flush()
    with open(stage.stage[stageNo]['path'] +'/COVkeywords-' + stage.stage[stageNo]['Path'] +'-.json', mode='r', encoding='utf-8') as fp2:
        # print(fp2.read())
